...
axs + scale_y_continuous(labels = scales::dollar_format(prefix="$")) # needs 'prefix='
leg + scale_fill_continuous(labels = scales::unit_format(suffix="k", scale=1e-3)) # suffix, scale added
```
...
1.  Recreate the following graphic:
    ...
    ggplot(mpg, aes(displ, hwy)) + 
      geom_point() +  
      scale_x_continuous("Displacement", labels = scales::unit_format(unit="L")) + 
      scale_y_continuous(quote(paste("Highway ", (frac(miles, gallon)))))  # unit= added
    ```
...
*   `scale_colour_manual()` is useful if you have your own discrete colour
    ...
    #https://www.r-project.org/nosvn/pandoc/wesanderson.html
